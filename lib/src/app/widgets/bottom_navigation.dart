...
class BottomNavigationView extends StatefulWidget {
   ...
   final String icono;
   const BottomNavigationView({Key key, @required this.icono, @required this.builder}) : super(key: key);
...
class BottomBarView extends StatefulWidget {
  const BottomBarView(
      {Key key, this.icono, this.tabIconsList, this.changeIndex, this.addClick})
      : super(key: key);
